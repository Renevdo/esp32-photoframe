...
Usage:
    python3 generate_partitions.py --sdkconfig sdkconfig.defaults boards/sdkconfig.defaults.board --output partitions.csv
"""
...
HEADER = """\
# Generated by scripts/generate_partitions.py - do not edit manually
